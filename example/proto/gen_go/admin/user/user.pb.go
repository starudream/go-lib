...
const file_admin_user_user_proto_rawDesc = "" +
	"\n" +
	"\x15admin/user/user.proto\x12\x0eapi.admin.user\x1a\x17validate/validate.proto\"N\n" +
	"\x04User\x12\x0e\n" +
	...
	"\n" +
	"AddUserReq\x12#\n" +
	"\busername\x18\x02 \x01(\tB\a\xfaB\x04r\x02\x10\x01R\busername\x12\x1a\n" +
	...
	"\x01x\x12\x03\xf8B\x01B8Z6github.com/starudream/go-lib/example/v2/api/admin/userb\x06proto3"
